...
function(a){a.preventDefault();c.prev()});e=(this.height-this.nextButton.height())/2;this.nextButton.css({top:e+"px",right:"10px"});this.prevButton.css({top:e+"px",left:"10px"})}if(this.options.captions)this.captionBar=b('<div class="caption"></div>').css({background:"rgba(0,0,0,0.6)",color:"#FFF","font-size":"20px","font-family":"montez, helvetica, arial, sans-serif","text-decoration":"none",padding:"4px 39px",opacity:0,position:"absolute","z-index":110,width:"100%",bottom:0}).css3({"transition-property":"opacity",
